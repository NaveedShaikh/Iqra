...
const EventCard = ({ event }: { event: IEvent }) => {
    ...
    const handleRegister = useCallback(() => {
        router.push(`/upcoming-events/${event._id}`);
    },[event._id]);
    return (
        <div className="max-w-sm rounded-xl overflow-hidden shadow-lg bg-gradient-to-br border border-grayLight from-white to-gray-100 hover:shadow-2xl transition-all duration-300 ease-in-out transform hover:-translate-y-1">
